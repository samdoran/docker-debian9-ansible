...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/samdoran/debian9-ansible.svg)](https://hub.docker.com/r/samdoran/debian9-ansible/) ![Docker Pulls](https://img.shields.io/docker/pulls/samdoran/debian9-ansible.svg)
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-debian9}-ansible:latest"
